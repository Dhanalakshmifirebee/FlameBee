        ...
        if (err) { throw err }
            ...
            cardSchema.cardDetails.countDocuments({ email: req.body.email }, (err, data) => {
                if (data == 0) {
                    ...
                    // req.body.foodImage = `http://192.168.0.112:8612/uploads/${req.files['foodImage'][0].filename}`
                    // req.body.restarauntImage = `http://192.168.0.112:8612/uploads/${req.files['restarauntImage'][0].filename}`
