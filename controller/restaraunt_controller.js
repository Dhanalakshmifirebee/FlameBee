...
const image = (req,res)=>{
    try{
        ...
        restarauntSchema.image.create(req.body,(err,data)=>{
            if(err) throw err
            console.log(data)
        ...
        console.log("line 11",req.body)
            restarauntSchema.addRestrauntByOwner.countDocuments({ email: req.body.email }, (err, data) => {
                ...
                if (data == 0) {
                    ...
                    // console.log('line 10', req.files['restaurantImage'][0].path)
                    // console.log('line 11', req.files['menuImage'][0].path)
                    // req.body.noOfPerson=1
                    // req.body.restaurantImage = `http://192.168.0.112:8612/uploads/${req.files.restaurantImage[0].filename}`
                    // req.body.menuImage = `http://192.168.0.112:8612/uploads/${req.files.menuImage[0].filename}`
                    // req.body.restarauntImage = `http://192.168.0.112:8612/uploads/${req.files['restaurantImage'][0].filename}`
                    // req.body.menuImage = `http://192.168.0.112:8612/uploads/${req.files['menuImage'][0].filename}`
...
const updateRestarauntByOwner = (req, res) => {
    ...
    //         z.push(result[1][0])
    //     })
    //     console.log("line 128",z.length)
    //     if (z.length == 1) {
    //         if (z[0].fieldname == 'restaurantImage') {
    //             req.body.restaurantImage = `http://192.168.0.112:8612/uploads${z[0].filename}`
    //             req.body.menuImage=" "
    //         } else {
    //             req.body.menuImage = `http://192.168.0.112:8612/uploads${z[0].filename}`
    ...
    //         if (z[0].fieldname == 'restaurantImage') {
    //             req.body.restaurantImage = `http://192.168.0.112:8612/uploads${z[0].filename}`
    //             req.body.menuImage = `http://192.168.0.112:8612/uploads${z[1].filename}`
    //         } else {
    //             req.body.restaurantImage = `http://192.168.0.112:8612/uploads${z[1].filename}`
    //             req.body.menuImage = `http://192.168.0.112:8612/uploads${z[0].filename}`
    //         }
    //     }
    try {
